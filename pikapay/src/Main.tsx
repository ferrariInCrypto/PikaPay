      ...
      <WhiteBox>
        ...
        <div className="container mx-auto ">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <button
              type="submit"
              className="bg-transparent bg-gray-800 text-gray-300 font-semibold  py-2 px-4 border border-gray-800 hover:border-transparent rounded shadow-md transition duration-300 ease-in-out"
            >
              Submit
            </button>
            {txnId && (
              <p className="mt-4">
                ...
                Transaction ID: https://testnet.bttcscan.com/tx/{txnId.slice(0,15)}
                </a>
              </p>
            )}
          </form>
...
const TransferBeneficialOwnership = () => {
  ...
  const transferBeneficialOwnership = async (
    ...
    const PIKAPAYContractAddress =
      "0xE1A5a5Da4bDab7a052c66BFC91Ee705ccc90B21A";
